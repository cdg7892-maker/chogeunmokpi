...
export const clinicPages: Record<ClinicPageData["slug"], ClinicPageData> = {
  pediatric: {
    ...
    principles: [
      { title: "비위 기능 보강", desc: "잘 먹고 흡수하는 힘을 키워 성장의 재료를 채웁니다." },
      { title: "수면 리듬 안정", desc: "깊은 잠과 회복 리듬을 도와 성장 호르몬 흐름을 살립니다." },
      { title: "뇌 피로 회복", desc: "수험생의 긴장과 피로를 낮춰 집중 유지력을 높입니다." },
      { title: "면역 기반 강화", desc: "잦은 감기와 비염으로 흔들리는 컨디션을 다잡습니다." },
    ],
    quizTitle: "소아·수험생 미니 진단",
